    ...
    _gsScope._gsDefine(
        ...
        function (t, e, i) {
            ...
            var p = function (t, i, s, r) {
                (i = i !== !1), (s = s !== !1), (r = r !== !1);
                for (
                    var n, a, o = f(r), l = i && s && r, h = o.length;
                    --h > -1;
            ...
            function (t, e, i) {
                ...
                return (
                    ...
                    (d.from = function (t, e, s, r) {
                        return this.add(
                            ((s.repeat && u.TweenMax) || i).from(t, e, s),
                            r
                        );
                    }),
                    ...
                    (d.add = function (r, n, a, o) {
                        ...
                        if (
                            ...
                            for (
                                f = this, p = f.rawTime() > r._startTime;
                                f._timeline;
                    ...
                    (h.render = function (t, e, i) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                if (
                                    s._active ||
                                    (m >= s._startTime && !s._paused && !s._gc)
                                ) {
                                    if (c === s) {
                                        for (
                                            c = s._prev;
                        ...
                        this._onUpdate &&
                            (e ||
                                (a.length && o(), this._callback("onUpdate"))),
                            h &&
                                (this._locked ||
                                    this._gc ||
                                    ((g === this._startTime ||
        ...
        (function () {
            var t = 180 / Math.PI,
                    ...
                    if (n)
                        for (t = [n].concat(t), l = t.length; --l > -1; )
                            "string" == typeof (c = t[l][s]) &&
                                "=" === c.charAt(1) &&
                                (t[l][s] =
                                    n[s] + Number(c.charAt(0) + c.substr(2)));
                    if (((o = t.length - 2), 0 > o))
                        return (
                ...
                u = function (t, n, a, l, u, c) {
                    ...
                    for (
                        e.length = i.length = s.length = 0, f = w.length;
                        --f > -1;
            ...
            function (t, e) {
                    ...
                    Y = (function () {
                        ...
                        return (
                            ...
                            (p =
                                ...
                                6 >
                                    Number(
                                        j.substr(j.indexOf("Version/") + 8, 1)
                                    )),
                    ...
                    $ = (B.convertToPixels = function (t, i, s, r, n) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                c[_ ? "borderLeftWidth" : "borderTopWidth"] =
                                    s + r;
                            else {
                                if (
                            ...
                            if (16 === o.length) {
                                ...
                                f.zOrigin &&
                                    ...
                                    f.svg &&
                                        ((f.x -=
                                            f.xOrigin -
                                            (f.xOrigin * P - f.yOrigin * O)),
                                        (f.y -=
                                            f.yOrigin -
                                            (f.yOrigin * k - f.xOrigin * A)));
                            } else if (
                                !(
                                    (Re &&
                                        !n &&
                                ...
                                (f.x = o[4] || 0),
                                    ...
                                    f.svg &&
                                        ((f.x -=
                                            f.xOrigin -
                                            (f.xOrigin * Y + f.yOrigin * q)),
                                        (f.y -=
                                            f.yOrigin -
                                            (f.xOrigin * U + f.yOrigin * V)));
                            }
                            f.zOrigin = g;
                ...
                (h = a.prototype),
                    ...
                    (h._enableTransforms = function (t) {
                        (this._transform =
                            this._transform || Ne(this._target, r, !0)),
                            (this._transformType =
                                (this._transform.svg && we) ||
                ...
                L = function (t, e, i, s) {
                    ...
                    for (
                        ...
                        (_ = n[o]),
                            ...
                            (c += _.length);
                    return (
                        (f += e.substr(c)), f && u.push(f), (u.setRatio = N), u
                    );
                },
                    ...
                    return (
                        "number" !== u &&
                            ...
                            "string" == typeof _ && (a || isNaN(_))
                                ...
                                : c ||
                                  (f.c = parseFloat(s) - parseFloat(_) || 0)),
                        f.c
                ...
                (O._updateRoot = D.render =
                    function () {
                        ...
                        if (
                            (F.length && Q(),
                            W.render(
                                (a.time - W._startTime) * W._timeScale,
                                !1,
                                !1
                            ),
                            G.render(
                                (a.frame - G._startTime) * G._timeScale,
                                !1,
                                !1
                            ),
                            F.length && Q(),
            ...
            (n._init = function () {
                ...
                (D.killTweensOf = D.killDelayedCallsTo =
                    function (t, e, i) {
                        ...
                        for (
                            var s = D.getTweensOf(t, e), r = s.length;
                            --r > -1;
